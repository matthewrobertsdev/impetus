...
output_display.configure(state=DISABLED, insertbackground='#00ff00', highlightcolor='#00ff00')
...
command_entry.configure(insertbackground='#00ff00', blockcursor=True, highlightcolor='#00ff00', fg='#00ff00')
